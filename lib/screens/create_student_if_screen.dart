...
class _CreateStudentInfoScreenState extends State<CreateStudentInfoScreen> {
  ...
  // bool isValidDateString(String inputString) {
  //   if (inputString.length != 8) {
  //     // Chuỗi không đủ độ dài
  //     return false;
  //   }
  //
  //   try {
  ...
  //
  //     // Chuyển đổi thành số để kiểm tra xem có phải là số hay không
  ...
  //     return true;
  //   } catch (e) {
  //     // Nếu có lỗi khi chuyển đổi, chuỗi không hợp lệ
  //     return false;
  //   }
  // }
